...
- [값(데이터)과 값을 화면에 표현하는 로직을 구분하여 구현하는 것이 왜 중요한가?(앱과제)](../main/App%20Programming/7주차/값%28데이터%29과%20값을%20화면에%20표현하는%20로직을%20구분하여%20구현하는%20것이%20왜%20중요한가%28앱과제%29.md)
